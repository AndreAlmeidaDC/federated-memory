# AGENTS.md — Adaptador para Google Antigravity

Este arquivo segue a convenção `AGENTS.md` adotada pelo Antigravity 2.0
(lançado em 19/05/2026 no Google I/O) como contrato de contexto para seus agentes.
Traduz o contrato neutro de [`../../00-global/AGENT.md`](../../00-global/AGENT.md) para o consumo do Antigravity.
...
- A regra vale em todos os modos do Antigravity (chat, agent mode, autonomous). O nível de aprovação altera a UX, não a política.
...
O vault é a memória persistente. O contexto da sessão Antigravity é volátil.
